...
all_var$eortc_br23 <- quo(br23_q31, br23_q32, br23_q33, br23_q34, br23_q35,
                          ...
                          brhl_scale)
all_var$eortc_eld15 <- quo(eld15_q54, eld15_q55, eld15_q56, eld15_q57, eld15_q58,
...
all_var$eq5d <- quo(mobility, self_care, usual_activity, pain_discomfort,
                    anxiety_depression, health_today, eq5d_number, eq5d_score)
all_var$therapy_assessment <- quo(any_treatment, endocrine_therapy, radiotherapy,
                                  chemotherapy, trastuzumab, surgery)
all_var$endocrine_therapy <- quo(primary_adjuvant, reason_pet, reason_pet_risk,
...
all_var$radiotherapy <- quo(which_breast_right_o, which_breast_left_o, r_site_breast_o,
...
all_var$chemotherapy <- quo(chemo_received, chemo_aes,
                            c_fatigue, c_anaemia, c_low_wc_count, c_thrombocytopenia, c_allergic,
                            c_hair_thinning, c_nausea, c_infection)
all_var$trastuzumab <- quo(trast_received, infusion_no, trast_aes, t_cardiac_fail,
                           t_flu_like, t_nausea, t_diarrhoea, t_headache, t_allergy)
all_var$clinical_assessment_non_pet <- quo(recurrence, recurrence_dt, recurrence_where_breast_o,
...
all_var$clinical_assessment_pet <- quo(uni_bilateral, primary_tumour, r_focal,
...
## Sets up some key components
factor_vars <- list()
factor_vars$eortc_c30 <- quo(c30_q1, c30_q2, c30_q3, c30_q4, c30_q5,
                             c30_q6, c30_q7, c30_q8, c30_q9, c30_q10,
                             c30_q11, c30_q12, c30_q13, c30_q14, c30_q15,
                             c30_q16, c30_q17, c30_q18, c30_q19, c30_q20,
                             c30_q21, c30_q22, c30_q23, c30_q24, c30_q25,
                             c30_q26, c30_q27, c30_q28, c30_q29, c30_q30)
factor_vars$eortc_br23 <- quo(br23_q31, br23_q32, br23_q33, br23_q34, br23_q35,
                              br23_q36, br23_q37, br23_q38, br23_q39, br23_q30,
                              br23_q31, br23_q32, br23_q33, br23_q34, br23_q35,
                              br23_q36, br23_q37, br23_q38, br23_q39, br23_q40,
                              br23_q41, br23_q42, br23_q43, br23_q44, br23_q45,
                              br23_q46, br23_q47, br23_q48, br23_q49, br23_q50,
                              br23_q51, br23_q52, br23_q53)
factor_vars$eortc_eld15 <- quo(eld15_q54, eld15_q55, eld15_q56, eld15_q57, eld15_q58,
                               eld15_q59, eld15_q60, eld15_q61, eld15_q62, eld15_q63, eld15_q64,
                               eld15_q65, eld15_q66, eld15_q67, eld15_q68)
factor_vars$eq5d <- quo(eq5d_number, eq5d_score)
factor_vars$therapy_assessment <- quo()
factor_vars$endocrine_therapy <- quo(primary_adjuvant, reason_pet, endocrine_type,
                                     ...
                                     et_nausea, et_diarrhoea, et_headache, et_vaginal_bleeding,
                                     et_vomiting, et_somnolence)
factor_vars$radiotherapy <- quo(l_radiotherapy_aes,
                                r_skin_erythema, r_pain, r_breast_oedema, r_breast_shrink,
                                r_breast_pain, l_skin_erythema, l_pain, l_breast_oedema,
                                l_breast_shrink, l_breast_pain)
factor_vars$chemotherapy <- quo(chemo_received, chemo_aes,
                                c_fatigue, c_anaemia, c_low_wc_count, c_thrombocytopenia, c_allergic,
                                c_hair_thinning, c_nausea, c_infection)
factor_vars$trastuzumab <- quo(trast_received, infusion_no, trast_aes, t_cardiac_fail,
                               t_flu_like, t_nausea, t_diarrhoea, t_headache, t_allergy)
factor_vars$clinical_assessment_non_pet <- quo(recurrence, new_tumour_yn,  clinical_plan)
factor_vars$clinical_assessment_pet <- quo(uni_bilateral, primary_tumour,
...
continuous_vars$eortc_c30 <- quo(ql_raw, ql_scale, pf_raw, pf_scale, rf_raw, rf_scale,
                                 ef_raw,ef_scale, cf_raw,cf_scale, sf_raw,sf_scale,
                                 fa_raw,fa_scale, nv_raw,nv_scale, pa_raw,pa_scale,
                                 dy_scale, sl_scale, ap_scale, co_scale, di_scale, fi_scale)
continuous_vars$eortc_br23 <- quo(brbi_raw, brbi_scale, brsef_raw, brsef_scale, brsee_scale, brfu_scale,
                                  brst_raw, brst_scale, brbs_raw, brbs_scale, bras_raw, bras_scale,
                                  brhl_scale)
continuous_vars$eortc_eld15 <- quo(mo_raw, mo_scale,
                                   wao_raw, wao_scale, wo_raw, wo_scale, mp_raw, mp_scale,
                                   boi_raw, boi_scale, js_scale, fs_scale)
continuous_vars$eq5d <- quo(eq5d_number, eq5d_score)
continuous_vars$therapy_assessment <- quo()
continuous_vars$endocrine_therapy <- quo()
continuous_vars$radiotherapy <- quo(which_breast_right_o, which_breast_left_o, r_site_breast_o,
                                    r_site_axilla_o, r_site_supraclavicular_o, r_site_chest_wall_o,
                                    r_site_other_o, r_breast_fractions, r_axilla_fractions,
                                    r_supra_fractions, r_chest_fractions, r_other_fractions,
                                    r_radiotherapy_aes,
                                    ...
                                    l_axilla_fractions, l_supra_fractions, l_chest_fractions,
                                    l_other_fractions)
continuous_vars$chemotherapy <- quo()
continuous_vars$trastuzumab <- quo(infusion_no)
continuous_vars$clinical_assessment_non_pet <- quo(recurrence_dt, recurrence_where_breast_o,
                                                   recurrence_where_chest_wall_o, recurrence_where_axilla_o,
                                                   recurrence_where_metastatic_o, recurrence_met_bone_o,
                                                   recurrence_met_liver_o, recurrence_met_lung_o,
                                                   recurrence_met_superclavicular_o, recurrence_met_brain_o,
...
continuous_vars$clinical_assessment_pet <- quo(r_num_tumours, r_cancer_palpable, r_size_clin_assess,
