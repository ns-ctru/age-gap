## Sets up some key components as quosures...
all_var_quos <- list()
all_var_quos$eortc_c30 <- quos(c30_q1, c30_q2, c30_q3, c30_q4, c30_q5,
...
all_var_quos$eortc_br23 <- quos(br23_q31, br23_q32, br23_q33, br23_q34, br23_q35,
                          ...
                          brhl_scale)
all_var_quos$eortc_eld15 <- quos(eld15_q54, eld15_q55, eld15_q56, eld15_q57, eld15_q58,
...
all_var_quos$eq5d <- quos(mobility, self_care, usual_activity, pain_discomfort,
                    anxiety_depression, health_today, eq5d_number, eq5d_score)
all_var_quos$therapy_assessment <- quos(any_treatment, endocrine_therapy, radiotherapy,
                                  chemotherapy, trastuzumab, surgery)
all_var_quos$endocrine_therapy <- quos(primary_adjuvant, reason_pet, reason_pet_risk,
...
all_var_quos$radiotherapy <- quos(which_breast_right_o, r_site_breast_o,
...
all_var_quos$chemotherapy <- quos(chemo_received, chemo_aes,
                            c_fatigue, c_anaemia, c_low_wc_count, c_thrombocytopenia, c_allergic,
                            c_hair_thinning, c_nausea, c_infection)
all_var_quos$trastuzumab <- quos(trast_received, infusion_no, trast_aes, t_cardiac_fail,
                           t_flu_like, t_nausea, t_diarrhoea, t_headache, t_allergy)
all_var_quos$clinical_assessment_non_pet <- quos(recurrence, recurrence_dt, recurrence_where_breast_o,
...
all_var_quos$clinical_assessment_pet <- quos(uni_bilateral_pet, primary_tumour_pet, r_focal_pet,
...
factor_vars_quos <- list()
factor_vars_quos$eortc_c30 <- quos(c30_q1, c30_q2, c30_q3, c30_q4, c30_q5,
                             c30_q6, c30_q7, c30_q8, c30_q9, c30_q10,
                             c30_q11, c30_q12, c30_q13, c30_q14, c30_q15,
                             c30_q16, c30_q17, c30_q18, c30_q19, c30_q20,
                             c30_q21, c30_q22, c30_q23, c30_q24, c30_q25,
                             c30_q26, c30_q27, c30_q28, c30_q29, c30_q30)
factor_vars_quos$eortc_br23 <- quos(br23_q31, br23_q32, br23_q33, br23_q34, br23_q35,
                              br23_q36, br23_q37, br23_q38, br23_q39, br23_q40,
                              br23_q41, br23_q42, br23_q43, br23_q44, br23_q45,
                              br23_q46, br23_q47, br23_q48, br23_q49, br23_q50,
                              br23_q51, br23_q52, br23_q53)
factor_vars_quos$eortc_eld15 <- quos(eld15_q54, eld15_q55, eld15_q56, eld15_q57, eld15_q58,
                               eld15_q59, eld15_q60, eld15_q61, eld15_q62, eld15_q63, eld15_q64,
                               eld15_q65, eld15_q66, eld15_q67, eld15_q68)
factor_vars_quos$eq5d <- quos(eq5d_number, eq5d_score)
factor_vars_quos$therapy_assessment <- quos()
factor_vars_quos$endocrine_therapy <- quos(primary_adjuvant, reason_pet, endocrine_type,
                                     ...
                                     et_nausea, et_diarrhoea, et_headache, et_vaginal_bleeding,
                                     et_vomiting, et_somnolence)
factor_vars_quos$radiotherapy <- quos(which_breast_right_o, r_site_breast_o,
                                 r_site_axilla_o, r_site_supraclavicular_o, r_site_chest_wall_o,
...
factor_vars_quos$chemotherapy <- quos(chemo_received, chemo_aes,
                                c_fatigue, c_anaemia, c_low_wc_count, c_thrombocytopenia, c_allergic,
                                c_hair_thinning, c_nausea, c_infection)
factor_vars_quos$trastuzumab <- quos(trast_received, infusion_no, trast_aes, t_cardiac_fail,
                               t_flu_like, t_nausea, t_diarrhoea, t_headache, t_allergy)
factor_vars_quos$clinical_assessment_non_pet <- quos(recurrence, new_tumour_yn,  clinical_plan)
factor_vars_quos$clinical_assessment_pet <- quos(uni_bilateral_pet, primary_tumour_pet,
...
## Sets up some key components
continuous_vars_quos <- list()
continuous_vars_quos$eortc_c30 <- quos(ql_raw, ql_scale, pf_raw, pf_scale, rf_raw, rf_scale,
                                 ef_raw,ef_scale, cf_raw,cf_scale, sf_raw,sf_scale,
                                 fa_raw,fa_scale, nv_raw,nv_scale, pa_raw,pa_scale,
                                 dy_scale, sl_scale, ap_scale, co_scale, di_scale, fi_scale)
continuous_vars_quos$eortc_br23 <- quos(brbi_raw, brbi_scale, brsef_raw, brsef_scale, brsee_scale, brfu_scale,
                                  brst_raw, brst_scale, brbs_raw, brbs_scale, bras_raw, bras_scale,
                                  brhl_scale)
continuous_vars_quos$eortc_eld15 <- quos(mo_raw, mo_scale,
                                   wao_raw, wao_scale, wo_raw, wo_scale, mp_raw, mp_scale,
                                   boi_raw, boi_scale, js_scale, fs_scale)
continuous_vars_quos$eq5d <- quos(eq5d_number, eq5d_score)
continuous_vars_quos$therapy_assessment <- quos()
continuous_vars_quos$endocrine_therapy <- quos()
continuous_vars_quos$radiotherapy <- quos(r_breast_fractions, r_axilla_fractions,
                                     r_supra_fractions, r_chest_fractions, r_other_fractions,
                                     l_breast_fractions, l_axilla_fractions,
                                     l_supra_fractions, l_chest_fractions, l_other_fractions)
continuous_vars_quos$chemotherapy <- quos()
continuous_vars_quos$trastuzumab <- quos(infusion_no)
continuous_vars_quos$clinical_assessment_non_pet <- quos(recurrence_dt, recurrence_where_breast_o,
                                                   recurrence_where_chest_wall_o, recurrence_where_axilla_o,
                                                   recurrence_where_metastatic_o, recurrence_met_bone_o,
                                                   recurrence_met_liver_o, recurrence_met_lung_o,
                                                   recurrence_met_superclavicular_o, recurrence_met_brain_o,
                                                   ...
                                                   plan_routine_radio_o, plan_routine_endocrine_o, plan_routine_chemo_o,
                                                   plan_routine_trast_o, plan_routine_oth_o, plan_routine_spcfy)
continuous_vars_quos$clinical_assessment_pet <- quos(r_num_tumours_pet, r_cancer_palpable_pet, r_size_clin_assess_pet,
...
## Sets up some key components as plain lists...
## all_var <- list()
...
##                                      et_nausea, et_diarrhoea, et_headache, et_vaginal_bleeding,
##                                      et_vomiting, et_somnolence)
## factor_vars$radiotherapy <- c(which_breast_right_o, r_site_breast_o,
##                                  r_site_axilla_o, r_site_supraclavicular_o, r_site_chest_wall_o,
##                                  r_site_other_o, r_radiotherapy_aes, r_skin_erythema, r_pain,
##                                  r_breast_oedema, r_breast_shrink, r_breast_pain,
##                                  which_breast_left_o, l_site_breast_o,
...
## factor_vars$clinical_assessment_pet <- c(uni_bilateral_pet, primary_tumour_pet,
##                                             r_focal_pet, r_cancer_palpable_pet,
##                                             r_method_assess_pet, r_axillary_present_pet,
##                                             l_focal_pet, l_cancer_palpable_pet,
##                                             l_method_assess_pet, l_axillary_present_pet,  clinical_plan2)
...
## continuous_vars$radiotherapy <- c(r_breast_fractions, r_axilla_fractions,
##                                      r_supra_fractions, r_chest_fractions, r_other_fractions,
##                                      l_breast_fractions, l_axilla_fractions,
##                                      l_supra_fractions, l_chest_fractions, l_other_fractions)
...
##                                                    plan_routine_radio_o, plan_routine_endocrine_o, plan_routine_chemo_o,
##                                                    plan_routine_trast_o, plan_routine_oth_o, plan_routine_spcfy)
## continuous_vars$clinical_assessment_pet <- c(r_num_tumours_pet, r_cancer_palpable_pet, r_size_clin_assess_pet,
##                                                r_size_ultrasound_pet,r_size_mammo_pet,
##                                                r_axillary_present_pet, r_axillary_nodes_pet, r_axillary_axis_pet,
##                                                l_focal_pet, l_num_tumours_pet, l_cancer_palpable_pet,
##                                                l_size_clin_assess_pet, l_method_assess_pet, l_size_ultrasound_pet,
