...
```
#### Ethnicity
```{r baseline_summary_demographics_ethnicity, echo = FALSE, cache = FALSE, fig.width = 8, fig.height = 8,eval = FALSE}
```
...
```{r baseline_summary_demographics_eq5d_sjp, echo = FALSE, cache = FALSE, fig.width = 3, fig.height = 3,eval = TRUE}
...
```{r baseline_summary_demographics_c30_sjp, echo = FALSE, cache = FALSE, fig.width = 3, fig.height = 3,eval = TRUE}
## Same graphs using sjPlot::sjp.stackfrq(), plot by each treatment.
## To combine use something like cow_plot::plot_grid() / sjPlot::plot_grid() /
## patchwork (see https://github.com/thomasp85/patchwork)
c30_sjp <- list()
...
```{r baseline_summary_demographics_br23_sjp, echo = FALSE, cache = FALSE, fig.width = 3, fig.height = 3,eval = TRUE}
## Same graphs using sjPlot::sjp.stackfrq(), plot by each treatment.
## To combine use something like cow_plot::plot_grid() / sjPlot::plot_grid() /
## patchwork (see https://github.com/thomasp85/patchwork)
br23_sjp <- list()
...
```{r baseline_summary_demographics_eld15_sjp, echo = FALSE, cache = FALSE, fig.width = 3, fig.height = 3,eval = TRUE}
## Same graphs using sjPlot::sjp.stackfrq(), plot by each treatment.
## To combine use something like cow_plot::plot_grid() / sjPlot::plot_grid() /
## patchwork (see https://github.com/thomasp85/patchwork)
eld15_sjp <- list()
...
```{r baseline_summary_demographics_adl_sjp, echo = FALSE, cache = FALSE, fig.width = 3, fig.height = 3,eval = FALSETRUE}
## Same graphs using sjPlot::sjp.stackfrq(), plot by each treatment.
## To combine use something like cow_plot::plot_grid() / sjPlot::plot_grid() /
## patchwork (see https://github.com/thomasp85/patchwork)
adl_sjp <- list()
...
```{r baseline_summary_demographics_iadl_sjp, echo = FALSE, cache = FALSE, fig.width = 3, fig.height = 3,eval = TRUE}
## Same graphs using sjPlot::sjp.stackfrq(), plot by each treatment.
## To combine use something like cow_plot::plot_grid() / sjPlot::plot_grid() /
## patchwork (see https://github.com/thomasp85/patchwork)
iadl_sjp <- list()
