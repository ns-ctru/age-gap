...
## The site allocation so that RCT component can be conducted
           left_join(.,
                     ...
                     by = c('site')) %>%
## And finally the '_ever' treatments such that the baseline summaries and
## cohort analyses can be made
           full_join(.,
                     master$therapy_ever,
                     by = c('individual_id'))
...
## Derive overall measurements for items recorded on both axes.
           mutate(site_breast           = ifelse(l_site_breast == 'Ticked' | r_site_breast == 'Ticked',
                                                 no  = 'No',
                                                 yes = 'Yes'),
                  site_breast           = factor(site_breast),
                  site_axilla           = ifelse(l_site_axilla == 'Ticked' | r_site_axilla == 'Ticked',
                                                 no  = 'No',
                                                 yes = 'Yes'),
                  site_axilla           = factor(site_axilla),
                  site_supraclavicular  = ifelse(l_site_supraclavicular == 'Ticked' | r_site_supraclavicular == 'Ticked',
                                                 no  = 'No',
                                                 yes = 'Yes'),
                  site_supraclavicular  = factor(site_supraclavicular),
                  site_chest_wall       = ifelse(l_site_chest_wall == 'Ticked' | r_site_chest_wall == 'Ticked',
                                                 no  = 'No',
                                                 yes = 'Yes'),
                  site_chest_wall       = factor(site_chest_wall),
                  site_other            = ifelse(l_site_other == 'Ticked' | r_site_other == 'Ticked',
                                                 no  = 'No',
                                                 yes = 'Yes'),
                  site_other            = factor(site_other),
                  breast_fractions      = pmax(l_breast_fractions, r_breast_fractions, na.rm = FALSE),
                  axilla_fractions      = pmax(l_axilla_fractions, r_axilla_fractions, na.rm = FALSE),
                  supra_fractions       = pmax(l_supra_fractions, r_supra_fractions, na.rm = FALSE),
                  chest_fractions       = pmax(l_chest_fractions, r_chest_fractions, na.rm = FALSE),
                  other_fractions       = pmax(l_other_fractions, r_other_fractions, na.rm = FALSE),
                  radiotherapy_aes      = ifelse(l_radiotherapy_aes == 'Yes' | r_radiotherapy_aes == 'Yes',
                                                 no  = 'No',
                                                 yes = 'Yes'),
                  radiotherapy_aes      = factor(radiotherapy_aes),
                  skin_erythema         = ifelse(l_skin_erythema == 'Yes' | r_skin_erythema == 'Yes',
                                                 no  = 'No',
                                                 yes = 'Yes'),
                  skin_erythema         = factor(skin_erythema),
                  pain                  = ifelse(l_pain == 'Yes' | r_pain == 'Yes',
                                                 no  = 'No',
                                                 yes = 'Yes'),
                  pain                  = factor(pain),
                  breast_oedema         = ifelse(l_breast_oedema == 'Yes' | r_breast_oedema == 'Yes',
                                                 no  = 'No',
                                                 yes = 'Yes'),
                  breast_oedema         = factor(breast_oedema),
                  breast_shrink         = ifelse(l_breast_shrink == 'Yes' | r_breast_shrink == 'Yes',
                                                 no  = 'No',
                                                 yes = 'Yes'),
                  breast_shrink         = factor(breast_shrink),
                  breast_pain           = ifelse(l_breast_pain == 'Yes' | r_breast_pain == 'Yes',
                                                 no  = 'No',
                                                 yes = 'Yes'),
                  breast_pain           = factor(breast_pain),
                  ## ToDo 2017-09-04 : How to reconcile these?
                  ## l_surgery_type
                  ## l_axillary_type
                  surgery_aes_acute     = ifelse(l_surgery_aes_acute == 'Yes' | r_surgery_aes_acute == 'Yes',
                                                 no  = 'No',
                                                 yes = 'Yes'),
                  surgery_aes_acute     = factor(surgery_aes_acute),
                  surgery_aes_chronic   = ifelse(l_surgery_aes_chronic == 'Yes' | r_surgery_aes_chronic == 'Yes',
                                                 no  = 'No',
                                                 yes = 'Yes'),
                  surgery_aes_chronic   = factor(surgery_aes_chronic),
                  sa_haemorrhage        = ifelse(l_sa_haemorrhage == 'Yes' | r_sa_haemorrhage == 'Yes',
                                                 no  = 'No',
                                                 yes = 'Yes'),
                  sa_haemorrhage        = factor(sa_haemorrhage),
                  sa_seroma             = ifelse(l_sa_seroma == 'Yes' | r_sa_seroma == 'Yes',
                                                 no  = 'No',
                                                 yes = 'Yes'),
                  sa_seroma             = factor(sa_seroma),
                  sa_haematoma          = ifelse(l_sa_haematoma == 'Yes' | r_sa_haematoma == 'Yes',
                                                 no  = 'No',
                                                 yes = 'Yes'),
                  sa_haematoma          = factor(sa_haematoma),
                  sa_infection          = ifelse(l_sa_infection == 'Yes' | r_sa_infection == 'Yes',
                                                 no  = 'No',
                                                 yes = 'Yes'),
                  sa_infection          = factor(sa_infection),
                  sa_necrosis           = ifelse(l_sa_necrosis == 'Yes' | r_sa_necrosis == 'Yes',
                                                 no  = 'No',
                                                 yes = 'Yes'),
                  sa_necrosis           = factor(sa_necrosis),
                  sc_wound_pain         = ifelse(l_sc_wound_pain == 'Yes' | r_sc_wound_pain == 'Yes',
                                                 no  = 'No',
                                                 yes = 'Yes'),
                  sc_wound_pain         = factor(sc_wound_pain),
                  sc_functional_diff    = ifelse(l_sc_functional_diff == 'Yes' | r_sc_functional_diff == 'Yes',
                                                          no  = 'No',
                                                          yes = 'Yes'),
                  sc_functional_diff    = factor(sc_functional_diff),
                  sc_neuropathy         = ifelse(l_sc_neuropathy == 'Yes' | r_sc_neuropathy == 'Yes',
                                                 no  = 'No',
                                                 yes = 'Yes'),
                  sc_neuropathy         = factor(sc_neuropathy),
                  sc_lymphoedema        = ifelse(l_sc_lymphoedema == 'Yes' | r_sc_lymphoedema == 'Yes',
                                                 no  = 'No',
                                                 yes = 'Yes'),
                  sc_lymphoedema        = factor(sc_lymphoedema),
                  ## ToDo 2017-09-04 : How to reconcile these? case_when() rules?
                  tumour_size           = pmax(l_tumour_size, r_tumour_size, na.rm = FALSE),
                  ...
                  tumour_grade          = pmax(l_tumour_grade_num, r_tumour_grade_num, na.rm = FALSE),
                  ## tumour_grade          = factor(tumour_grade,
                  ##                                levels = c(1:4),
                  ##                                labels = c('I', 'II', 'III', 'Not available')),
                  allred                = pmax(l_allred, r_allred, na.rm = FALSE),
                  h_score               = pmax(l_h_score, r_h_score, na.rm = FALSE),
                  ## ToDo 2017-09-04 : How to reconcile these? case_when() rules?
                  ...
                  onco_used             = ifelse(l_onco_used == 'Yes' | r_onco_used == 'Yes',
                                                 no  = 'No',
                                                 yes = 'Yes'),
                  ...
                  margins_clear         = ifelse(l_margins_clear == 'Yes' | r_margins_clear == 'Yes',
                                                 no  = 'No',
                                                 yes = 'Yes'),
                  margins_clear         = factor(margins_clear),
                  margin                = pmax(l_margin, r_margin, na.rm = FALSE),
                  ...
                  nodes_excised         = pmax(l_nodes_excised, r_nodes_excised, na.rm = FALSE),
                  nodes_involved        = pmax(l_nodes_involved, r_nodes_involved, na.rm = FALSE),
                  ## ToDo 2017-09-04 : How to reconcile these, only really a handful that are discordant
                  ## l_focal_pet
                  num_tumours_pet       = pmax(l_num_tumours_pet, r_num_tumours_pet, na.rm = FALSE),
                  ...
                  size_clin_assess_pet  = pmax(l_size_clin_assess_pet, r_size_clin_assess_pet, na.rm = FALSE),
                  ## ToDo 2017-09-04 : How to reconcile these, none are discordant
                  ## l_method_assess_pet
                  size_ultrasound_pet   = pmax(l_size_ultrasound_pet, r_size_ultrasound_pet, na.rm = FALSE),
                  size_mammo_pet        = pmax(l_size_mammo_pet, r_size_mammo_pet, na.rm = FALSE),
                  ...
                  axillary_nodes_pet    = pmax(l_axillary_nodes_pet, r_axillary_nodes_pet, na.rm = FALSE),
                  axillary_axis_pet     = pmax(l_axillary_axis_pet, r_axillary_axis_pet, na.rm = FALSE))
