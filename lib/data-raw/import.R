...
master$lookups_fields <- rbind(master$lookups_fields,
                               c('Radiotherapy', '', 'which_breast_right_o', 'Right Breast treated with Radiotherapy'),
                               c('Radiotherapy', '', 'r_site_breast_o', 'Treatment Site (Right) : Breast'),
                               c('Radiotherapy', '', 'r_site_axilla_o', 'Treatment Site (Right) : Axilla'),
                               c('Radiotherapy', '', 'r_site_supraclavicular_o', 'Treatment Site (Right) : Suprclavicular'),
                               c('Radiotherapy', '', 'r_site_chest_wall_o', 'Treatment Site (Right) : Chest Wall'),
                               c('Radiotherapy', '', 'r_site_other_o', 'Treatment Site (Right) : Other'),
                               c('Radiotherapy', '', 'which_breast_left_o', 'Left Breast treated with Radiotherapy'),
                               c('Radiotherapy', '', 'l_site_breast_o', 'Treatment Site (Left) : Breast'),
                               c('Radiotherapy', '', 'l_site_axilla_o', 'Treatment Site (Left) : Axilla'),
                               c('Radiotherapy', '', 'l_site_supraclavicular_o', 'Treatment Site (Left) : Supraclavicular'),
                               c('Radiotherapy', '', 'l_site_chest_wall_o', 'Treatment Site (Left) : Chest Wall'),
                               c('Radiotherapy', '', 'l_site_other_o', 'Treatment Site (Left) : Other'),
                               c('Clinical Assessment (PET)', '', 'metastatic_where_bone_o', 'Metastatic : Bone'),
                               c('Clinical Assessment (PET)', '', 'metastatic_where_lung_o', 'Metastatic : Lung'),
                               c('Clinical Assessment (PET)', '', 'metastatic_where_cervical_node_o', 'Metastatic : Cervical Node'),
                               c('Clinical Assessment (PET)', '', 'metastatic_where_other_o', 'Metastatic : Other'),
                               c('Clinical Assessment (PET)', '', 'metastatic_where_liver_o', 'Metastatic : Liver'),
                               c('Clinical Assessment (PET)', '', 'metastatic_where_brain_o', 'Metastatic : Brain'),
                               c('Clinical Assessment (PET)', '', 'plan_change_surgery_o', 'Treatment plan changed due to recurrence : Surgery'),
                               c('Clinical Assessment (PET)', '', 'plan_change_radio_o', 'Treatment plan changed due to recurrence : Radiotherapy'),
                               c('Clinical Assessment (PET)', '', 'plan_change_antioestrogen_o', 'Treatment plan changed due to recurrence : Anti-oestrogen'),
                               c('Clinical Assessment (non-PET)', '', 'recurrence_where_breast_o', 'Recurrence : Breast'),
                               c('Clinical Assessment (non-PET)', '', 'recurrence_where_chest_wall_o', 'Recurrence : Chest Wall'),
                               c('Clinical Assessment (non-PET)', '', 'recurrence_where_axilla_o', 'Recurrence : Axilla'),
                               c('Clinical Assessment (non-PET)', '', 'recurrence_where_metastatic_o', 'Recurrence : Metastatic'),
                               c('Clinical Assessment (non-PET)', '', 'recurrence_where_met_bone_o', 'Recurrence : Bone (Metastatic)'),
                               c('Clinical Assessment (non-PET)', '', 'recurrence_where_met_liver_o', 'Recurrence : Liver (Metastatic'),
                               c('Clinical Assessment (non-PET)', '', 'recurrence_where_met_lung_o', 'Recurrence : Lung (Metastatic)'),
                               c('Clinical Assessment (non-PET)', '', 'recurrence_where_met_superclavicular_o', 'Recurrence : Superclavicular (Metatstatic)'),
                               c('Clinical Assessment (non-PET)', '', 'recurrence_where_met_brain_o', 'Recurrence : Brain (Metastatic)'),
                               c('Clinical Assessment (non-PET)', '', 'recurrence_where_met_other_o', 'Recurrence : Other'),
                               c('Clinical Assessment (non-PET)', '', 'plan_local_surgery_o', 'Therapy due to local recurrence : Surgery'),
                               c('Clinical Assessment (non-PET)', '', 'plan_local_radio_o', 'Therapy due to local recurrence : Radiotherapy'),
                               c('Clinical Assessment (non-PET)', '', 'plan_local_endocrine_o', 'Therapy due to local recurrence : Endocrine Therapy'),
                               c('Clinical Assessment (non-PET)', '', 'plan_local_chemo_o', 'Therapy due to local recurrence : Chemotherapy'),
                               c('Clinical Assessment (non-PET)', '', 'plan_local_trast_o', 'Therapy due to local recurrence : Trastuzumab'),
                               c('Clinical Assessment (non-PET)', '', 'plan_local_oth_o', 'Therapy due to local recurrence : Other'),
                               c('Clinical Assessment (non-PET)', '', 'plan_met_radio_o', 'Therapy due to metastatic recurrence : Radiotherapy'),
                               c('Clinical Assessment (non-PET)', '', 'plan_met_endocrine_o', 'Therapy due to metastatic recurrence : Endocrine Therapy'),
                               c('Clinical Assessment (non-PET)', '', 'plan_met_chemo_o', 'Therapy due to metastatic recurrence : Chemotherapy'),
                               c('Clinical Assessment (non-PET)', '', 'plan_met_trast_o', 'Therapy due to metastatic recurrence : Trastuzumab'),
                               c('Clinical Assessment (non-PET)', '', 'plan_met_oth_o', 'Therapy due to metastatic recurrence : Other'),
                               c('Clinical Assessment (non-PET)', '', 'plan_routine_surgery_o', 'Routine Therapy : Surgery'),
                               c('Clinical Assessment (non-PET)', '', 'plan_routine_radio_o', 'Routine Therapy : Radiotherapy'),
                               c('Clinical Assessment (non-PET)', '', 'plan_routine_endocrine_o', 'Routine Therapy : Endocrine Therapy'),
                               c('Clinical Assessment (non-PET)', '', 'plan_routine_chemo_o', 'Routine Therapy : Chemotherapy'),
                               c('Clinical Assessment (non-PET)', '', 'plan_routine_trast_o', 'Routine Therapy : Trastuzumab'),
                               c('Clinical Assessment (non-PET)', '', 'plan_routine_oth_o', 'Routine Therapy : Other'),
                               c('Abridged Patient Generated Assessment', '', 'symptoms_2_week_no_problems_o', 'Symptoms in the Past 2 Weeks : None')
                               c('Abridged Patient Generated Assessment', '', 'symptoms_2_week_no_appetite_o', 'Symptoms in the Past 2 Weeks : No Appetite'),
                               c('Abridged Patient Generated Assessment', '', 'symptoms_2_week_feeling_full_o', 'Symptoms in the Past 2 Weeks : Feeling Full'),
                               c('Abridged Patient Generated Assessment', '', 'symptoms_2_week_food_tasting_funny_o', 'Symptoms in the Past 2 Weeks : Food Tasting Funny'),
                               c('Abridged Patient Generated Assessment', '', 'symptoms_2_week_vomiting_o', 'Symptoms in the Past 2 Weeks : Vomiting'),
                               c('Abridged Patient Generated Assessment', '', 'symptoms_2_week_nausea_o', 'Symptoms in the Past 2 Weeks : Nausea'),
                               c('Abridged Patient Generated Assessment', '', 'symptoms_2_week_pain_o', 'Symptoms in the Past 2 Weeks : Pain'),
                               c('Abridged Patient Generated Assessment', '', 'symptoms_2_week_other_o', 'Symptoms in the Past 2 Weeks : Other'),
                               c('Abridged Patient Generated Assessment', '', 'symptoms_2_week_dry_mouth_o', 'Symptoms in the Past 2 Weeks : Dry Mouth'),
                               c('Abridged Patient Generated Assessment', '', 'symptoms_2_week_mouth_sores_o', 'Symptoms in the Past 2 Weeks : Mouth Sores'),
                               c('Abridged Patient Generated Assessment', '', 'symptoms_2_week_constipation_o', 'Symptoms in the Past 2 Weeks : Constipation'),
                               c('Abridged Patient Generated Assessment', '', 'symptoms_2_week_diarrhoea_o', 'Symptoms in the Past 2 Weeks : Diarrhoea'),
                               c('Abridged Patient Generated Assessment', '', 'symptoms_2_week_problems_swallowing_o', 'Symptoms in the Past 2 Weeks : Problems Swallowing'),
                               c('Abridged Patient Generated Assessment', '', 'symptoms_2_week_smells_bother_o', 'Symptoms in the Past 2 Weeks : Smells Bother'),
                               c('Breast Cancer Treatment Choices - chemo vs no chemo.csv', '', 'influence_dcsn_int_no_dec_o', 'What influenced you most in making your decision : No decision'),
                               c('Breast Cancer Treatment Choices - chemo vs no chemo.csv', '', 'influence_dcsn_int_tlk_fam_o', 'What influenced you most in making your decision : Talking to family'),
                               c('Breast Cancer Treatment Choices - chemo vs no chemo.csv', '', 'influence_dcsn_int_rd_bklt_o', 'What influenced you most in making your decision : Reading booklet'),
                               c('Breast Cancer Treatment Choices - chemo vs no chemo.csv', '', 'influence_dcsn_int_rd_oth_o', 'What influenced you most in making your decision : Reading other'),
                               c('Breast Cancer Treatment Choices - chemo vs no chemo.csv', '', 'influence_dcsn_int_opt_grd_o', 'What influenced you most in making your decision : Option grid'),
                               c('Breast Cancer Treatment Choices - chemo vs no chemo.csv', '', 'influence_dcsn_int_tlk_hlth_prof_o', 'What influenced you most in making your decision : Talking to health professional'),
                               c('Breast Cancer Treatment Choices - chemo vs no chemo.csv', '', 'influence_dcsn_int_tlk_gp_o', 'What influenced you most in making your decision : Talking to GP'),
                               c('Breast Cancer Treatment Choices - chemo vs no chemo.csv', '', 'influence_dcsn_int_tlk_oth_pts_o', 'What influenced you most in making your decision : Talking to other patients'),
                               c('Breast Cancer Treatment Choices - chemo vs no chemo.csv', '', 'influence_dcsn_int_other_o', 'What influenced you most in making your decision : Other'),
                               c('Breast Cancer Treatment Choices - chemo vs no chemo.csv', '', 'influence_dcsn_cont_no_dec_o', 'What influenced you most in making your decision : No decision'),
                               c('Breast Cancer Treatment Choices - chemo vs no chemo.csv', '', 'influence_dcsn_cont_tlk_fam_o', 'What influenced you most in making your decision : Talking to family'),
                               c('Breast Cancer Treatment Choices - chemo vs no chemo.csv', '', 'influence_dcsn_cont_rd_oth_o', 'What influenced you most in making your decision : Reading other'),
                               c('Breast Cancer Treatment Choices - chemo vs no chemo.csv', '', 'influence_dcsn_cont_tlk_hlth_prof_o', 'What influenced you most in making your decision : Talking to healthcare professional'),
                               c('Breast Cancer Treatment Choices - chemo vs no chemo.csv', '', 'influence_dcsn_cont_tlk_gp_o', 'What influenced you most in making your decision : Talking to GP'),
                               c('Breast Cancer Treatment Choices - chemo vs no chemo.csv', '', 'influence_dcsn_cont_tlk_oth_pts_o', 'What influenced you most in making your decision : Talking to other patients'),
                               c('Breast Cancer Treatment Choices - chemo vs no chemo.csv', '', 'influence_dcsn_cont_other_o', 'What influenced you most in making your decision : Other'),
                               c('Breast Cancer Treatment Choices - surgery vs pills', '', 'influence_dcsn_int_no_dec_o', 'What influenced you most in making your decision : No decision'),
                               c('Breast Cancer Treatment Choices - surgery vs pills', '', 'influence_dcsn_int_tlk_fam_o', 'What influenced you most in making your decision : Talking to family'),
                               c('Breast Cancer Treatment Choices - surgery vs pills', '', 'influence_dcsn_int_rd_bklt_o', 'What influenced you most in making your decision : Reading booklet'),
                               c('Breast Cancer Treatment Choices - surgery vs pills', '', 'influence_dcsn_int_rd_oth_o', 'What influenced you most in making your decision : Reading other'),
                               c('Breast Cancer Treatment Choices - surgery vs pills', '', 'influence_dcsn_int_opt_grd_o', 'What influenced you most in making your decision : Option grid'),
                               c('Breast Cancer Treatment Choices - surgery vs pills', '', 'influence_dcsn_int_tlk_hlth_prof_o', 'What influenced you most in making your decision : Talking to health care professional'),
                               c('Breast Cancer Treatment Choices - surgery vs pills', '', 'influence_dcsn_int_tlk_gp_o', 'What influenced you most in making your decision : Talking to GP'),
                               c('Breast Cancer Treatment Choices - surgery vs pills', '', 'influence_dcsn_int_tlk_oth_pts_o', 'What influenced you most in making your decision : Talking to other patients'),
                               c('Breast Cancer Treatment Choices - surgery vs pills', '', 'influence_dcsn_int_other_o', 'What influenced you most in making your decision : Other'),
                               c('Breast Cancer Treatment Choices - surgery vs pills', '', 'influence_dcsn_cont_no_dec_o', 'What influenced you most in making your decision : No decision'),
                               c('Breast Cancer Treatment Choices - surgery vs pills', '', 'influence_dcsn_cont_tlk_fam_o', 'What influenced you most in making your decision : Talking to family'),
                               c('Breast Cancer Treatment Choices - surgery vs pills', '', 'influence_dcsn_cont_rd_oth_o', 'What influenced you most in making your decision : Reading other'),
                               c('Breast Cancer Treatment Choices - surgery vs pills', '', 'influence_dcsn_cont_tlk_hlth_prof_o', 'What influenced you most in making your decision : Talking to healthcare professional'),
                               c('Breast Cancer Treatment Choices - surgery vs pills', '', 'influence_dcsn_cont_tlk_gp_o', 'What influenced you most in making your decision : Talking to GP'),
                               c('Breast Cancer Treatment Choices - surgery vs pills', '', 'influence_dcsn_cont_tlk_oth_pts_o', 'What influenced you most in making your decision : Talking to other patients'),
                               c('Breast Cancer Treatment Choices - surgery vs pills', '', 'influence_dcsn_cont_other_o', 'What influenced you most in making your decision : Other'),
                               c('Discussing treatment options', '', 'booklet_yes_int_risk_info_o', 'Booklet : Personalised risk information'),
                               c('Discussing treatment options', '', 'booklet_yes_int_grid_o', 'Booklet : Option grid'),
                               c('Discussing treatment options', '', 'booklet_yes_int_booklet_o', 'Booklet : Information'),
                               c('Discussing treatment options', '', 'booklet_yes_int_other', 'Booklet : Other'),
                               c('Discussing treatment options', '', 'info_taken_read_all_o', 'How was information taken away used : Read all'),
                               c('Discussing treatment options', '', 'info_taken_read_some_o', 'How was information taken away used : Read some'),
                               c('Discussing treatment options', '', 'info_taken_not_read_o', 'How was information taken away used : Not read'),
                               c('Discussing treatment options', '', 'info_taken_showed_fam_o', 'How was information taken away used : Showed family'),
                               c('Discussing treatment options', '', 'info_taken_blank_sec_o', 'How was information taken away used : Blank section'),
                               c('Discussing treatment options', '', 'info_taken_other', 'How was information taken away used : Other'),
                               c('Surgery and Post Operative Pathology', '', 'which_breast_right_o', 'Surgery and Post Operative Pathology of Right Breast'),
                               c('Surgery and Post Operative Pathology', '', 'which_breast_left_o', 'Surgery and Post Operative Pathology of Right Left'),
                               c('Surgery and Post Operative Pathology', '', 'r_designation_anterior_o', 'Right Breast Designation : Anterior'),
                               c('Surgery and Post Operative Pathology', '', 'r_designation_posterior_o', 'Right Breast Designation : Posterior'),
                               c('Surgery and Post Operative Pathology', '', 'r_designation_lateral_o', 'Right Breast Designation : Lateral'),
                               c('Surgery and Post Operative Pathology', '', 'r_designation_medial_o', 'Right Breast Designation : Medial'),
                               c('Surgery and Post Operative Pathology', '', 'r_designation_superior_o', 'Right Breast Designation : Superior'),
                               c('Surgery and Post Operative Pathology', '', 'r_designation_inferior_o', 'Right Breast Designation : Inferior'),
                               c('Surgery and Post Operative Pathology', '', 'l_designation_anterior_o', 'Left Breast Designation : Anterior'),
                               c('Surgery and Post Operative Pathology', '', 'l_designation_posterior_o', 'Left Breast Designation : Posterior'),
                               c('Surgery and Post Operative Pathology', '', 'l_designation_lateral_o', 'Left Breast Designation : Lateral'),
                               c('Surgery and Post Operative Pathology', '', 'l_designation_medial_o', 'Left Breast Designation : Medial'),
                               c('Surgery and Post Operative Pathology', '', 'l_designation_superior_o', 'Left Breast Designation : Superior'),
                               c('Surgery and Post Operative Pathology', '', 'l_designation_inferior_o', 'Left Breast Designation : Inferior'),
                               c('Treatment decision', '', 'odt_staff_used_no_not_time_o', 'Online Decision Tool (Staff) : Not Time'),
                               c('Treatment decision', '', 'odt_staff_used_no_pt_not_suit_o', 'Online Decision Tool (Staff) : Not suitable'),
                               c('Treatment decision', '', 'odt_staff_used_no_staff_not_like_o', 'Online Decision Tool (Staff) : Staff not like'),
                               c('Treatment decision', '', 'odt_staff_used_no_no_access_o', 'Online Decision Tool (Staff) : No Access'),
                               c('Treatment decision', '', 'odt_staff_used_no_already_decide_o', 'Online Decision Tool (Staff) : Already decided'),
                               c('Treatment decision', '', 'odt_staff_used_no_other', 'Online Decision Tool (Staff) : Other'),
                               c('Treatment decision', '', 'odt_pt_shown_no_not_time_o', 'Online Decision Tool (Patient not shown) : Not time'),
                               c('Treatment decision', '', 'odt_pt_shown_no_pt_not_suit_o', 'Online Decision Tool (Patient not shown) : Not suitable'),
                               c('Treatment decision', '', 'odt_pt_shown_no_staff_not_like_o', 'Online Decision Tool (Patient not shown) : Staff not like'),
                               c('Treatment decision', '', 'odt_pt_shown_no_no_access_o', 'Online Decision Tool (Patient not shown) : No Access'),
                               c('Treatment decision', '', 'odt_pt_shown_no_distressed_o', 'Online Decision Tool (Patient not shown) : Distressed'),
                               c('Treatment decision', '', 'odt_pt_shown_no_not_understood_o', 'Online Decision Tool (Patient not shown) : Not Understood'),
                               c('Treatment decision', '', 'odt_pt_shown_no_decided_o', 'Online Decision Tool (Patient not shown) : Already decided'),
                               c('Treatment decision', '', 'odt_pt_shown_no_fam_reluctant_o', 'Online Decision Tool (Patient not shown) : Family reluctant'),
                               c('Treatment decision', '', 'odt_pt_shown_no_other', 'Online Decision Tool (Patient not shown) : Other'),
                               c('Treatment decision', '', 'odt_taken_home_no_not_time_o', 'Online Decision Tool (Print out not taken home) : Not time'),
                               c('Treatment decision', '', 'odt_taken_home_no_pt_not_suit_o', 'Online Decision Tool (Print out not taken home) : Not suitable'),
                               c('Treatment decision', '', 'odt_taken_home_no_staff_not_like_o', 'Online Decision Tool (Print out not taken home) : Staff not like'),
                               c('Treatment decision', '', 'odt_taken_home_no_no_access_o', 'Online Decision Tool (Print out not taken home) : No Access'),
                               c('Treatment decision', '', 'odt_taken_home_no_not_offer_o', 'Online Decision Tool (Print out not taken home) : Not offered'),
                               c('Treatment decision', '', 'odt_taken_home_no_distressed_o', 'Online Decision Tool (Print out not taken home) : Distressed'),
                               c('Treatment decision', '', 'odt_taken_home_no_not_understood_o', 'Online Decision Tool (Print out not taken home) : Not Understood'),
                               c('Treatment decision', '', 'odt_taken_home_no_decided_o', 'Online Decision Tool (Print out not taken home) : Already decided'),
                               c('Treatment decision', '', 'odt_taken_home_no_pt_reluctant_o', 'Online Decision Tool (Print out not taken home) : Patient reluctant'),
                               c('Treatment decision', '', 'odt_taken_home_no_fam_reluctant_o', 'Online Decision Tool (Print out not taken home) : Family reluctant'),
                               c('Treatment decision', '', 'odt_taken_home_no_other', 'Online Decision Tool (Print out not taken home) : Other'),
                               c('Treatment decision', '', 'og_staff_used_no_not_time_o', 'Option Grid Not Used : Not Time'),
                               c('Treatment decision', '', 'og_staff_used_no_pt_not_suit_o', 'Option Grid Not Used : Patient not suitable'),
                               c('Treatment decision', '', 'og_staff_used_no_staff_not_like_o', 'Option Grid Not Used : Staff not like'),
                               c('Treatment decision', '', 'og_staff_used_no_not_avail_o', 'Option Grid Not Used : Not available'),
                               c('Treatment decision', '', 'og_staff_used_no_distressed_o', 'Option Grid Not Used : Distressed'),
                               c('Treatment decision', '', 'og_staff_used_no_not_understood_o', 'Option Grid Not Used : Not Understood'),
                               c('Treatment decision', '', 'og_staff_used_no_decided_o', 'Option Grid Not Used : Already decided'),
                               c('Treatment decision', '', 'og_staff_used_no_pt_reluctant_o', 'Option Grid Not Used : Patient Reluctant'),
                               c('Treatment decision', '', 'og_staff_used_no_fam_reluctant_o', 'Option Grid Not Used : Family Reluctant'),
                               c('Treatment decision', '', 'og_staff_used_no_other', 'Option Grid Not Used : Other'),
                               c('Treatment decision', '', 'og_taken_home_no_not_time_o', 'Option Grid Not Taken Home : '),
                               c('Treatment decision', '', 'og_taken_home_no_pt_not_suit_o', 'Option Grid Not Taken Home : '),
                               c('Treatment decision', '', 'og_taken_home_no_staff_not_like_o', 'Option Grid Not Taken Home : '),
                               c('Treatment decision', '', 'og_taken_home_no_not_avail_o', 'Option Grid Not Taken Home : '),
                               c('Treatment decision', '', 'og_taken_home_no_not_offer_o', 'Option Grid Not Taken Home : '),
                               c('Treatment decision', '', 'og_taken_home_no_distressed_o', 'Option Grid Not Taken Home : '),
                               c('Treatment decision', '', 'og_taken_home_no_not_understood_o', 'Option Grid Not Taken Home : '),
                               c('Treatment decision', '', 'og_taken_home_no_decided_o', 'Option Grid Not Taken Home : '),
                               c('Treatment decision', '', 'og_taken_home_no_pt_reluctant_o', 'Option Grid Not Taken Home : '),
                               c('Treatment decision', '', 'og_taken_home_no_fam_reluctant_o', 'Option Grid Not Taken Home : '),
                               c('Treatment decision', '', 'og_taken_home_no_other', 'Option Grid Not Taken Home : Other'),
                               c('Treatment decision', '', 'b_staff_used_no_not_time_o', 'Booklet (Staff not used) : Not Time'),
                               c('Treatment decision', '', 'b_staff_used_no_pt_not_suit_o', 'Booklet (Staff not used) : Patient not suitable'),
                               c('Treatment decision', '', 'b_staff_used_no_staff_not_like_o', 'Booklet (Staff not used) : Staff not like'),
                               c('Treatment decision', '', 'b_staff_used_no_not_avail_o', 'Booklet (Staff not used) : Not available'),
                               c('Treatment decision', '', 'b_staff_used_no_distressed_o', 'Booklet (Staff not used) : Distressed'),
                               c('Treatment decision', '', 'b_staff_used_no_not_understood_o', 'Booklet (Staff not used) : Not understood'),
                               c('Treatment decision', '', 'b_staff_used_no_decided_o', 'Booklet (Staff not used) : Already decided'),
                               c('Treatment decision', '', 'b_staff_used_no_pt_reluctant_o', 'Booklet (Staff not used) : Patient reluctant'),
                               c('Treatment decision', '', 'b_staff_used_no_fam_reluctant_o', 'Booklet (Staff not used) : Family reluctant'),
                               c('Treatment decision', '', 'b_staff_used_no_other', 'Booklet (Staff not used) : Other'),
                               c('Treatment decision', '', 'b_taken_home_no_not_time_o', 'Booklet (not taken home) : Not time'),
                               c('Treatment decision', '', 'b_taken_home_no_pt_not_suit_o', 'Booklet (not taken home) : Patient not suitable'),
                               c('Treatment decision', '', 'b_taken_home_no_staff_not_like_o', 'Booklet (not taken home) : Staff not like'),
                               c('Treatment decision', '', 'b_taken_home_no_not_avail_o', 'Booklet (not taken home) : Not Available'),
                               c('Treatment decision', '', 'b_taken_home_no_not_offer_o', 'Booklet (not taken home) : Not Offered'),
                               c('Treatment decision', '', 'b_taken_home_no_distressed_o', 'Booklet (not taken home) : Distressed'),
                               c('Treatment decision', '', 'b_taken_home_no_not_understood_o', 'Booklet (not taken home) : Not Understood'),
                               c('Treatment decision', '', 'b_taken_home_no_decided_o', 'Booklet (not taken home) : Already Decided'),
                               c('Treatment decision', '', 'b_taken_home_no_pt_reluctant_o', 'Booklet (not taken home) : Patient reluctant'),
                               c('Treatment decision', '', 'b_taken_home_no_fam_reluctant_o', 'Booklet (not taken home) : Family reluctant'),
                               c('Treatment decision', '', 'b_taken_home_no_other', 'Booklet (not taken home) : Other')
                               )
...
duplicated_var_names$chemo_no_chemo <- c('know_enough',
                                         ...
                                         'decision',
                                         'moment_think',
                                         'influence_dcsn_int_no_dec_o',
                                         'influence_dcsn_int_tlk_fam_o',
                                         'influence_dcsn_int_rd_bklt_o',
                                         'influence_dcsn_int_rd_oth_o',
                                         'influence_dcsn_int_opt_grd_o',
                                         'influence_dcsn_int_tlk_hlth_prof_o',
                                         'influence_dcsn_int_tlk_gp_o',
                                         'influence_dcsn_int_tlk_oth_pts_o',
                                         'influence_dcsn_int_other_o',
                                         'other_int',
                                         'influence_dcsn_cont_no_dec_o',
                                         'influence_dcsn_cont_tlk_fam_o',
                                         'influence_dcsn_cont_rd_oth_o',
                                         'influence_dcsn_cont_tlk_hlth_prof_o',
                                         'influence_dcsn_cont_tlk_gp_o',
                                         'influence_dcsn_cont_tlk_oth_pts_o',
                                         'influence_dcsn_cont_other_o',
                                         'other_cont')
...
all_var$trastuzumab <- quos(trast_received, infusion_no, trast_aes, t_cardiac_fail,
                            t_flu_like, t_nausea, t_diarrhoea, t_headache, t_allergy)
all_var$clinical_assessment_non_pet <- quos(recurrence, recurrence_dt, recurrence_where_breast_o,
                                           recurrence_where_chest_wall_o, recurrence_where_axilla_o,
                                           recurrence_where_metastatic_o, recurrence_met_bone_o,
                                           recurrence_met_liver_o, recurrence_met_lung_o,
                                           recurrence_met_superclavicular_o, recurrence_met_brain_o,
...
factor_vars$chemotherapy <- quos(chemo_received, chemo_aes,
                                c_fatigue, c_anaemia, c_low_wc_count, c_thrombocytopenia, c_allergic,
                                c_hair_thinning, c_nausea, c_infection)
factor_vars$trastuzumab <- quos(which_breast_right_o, r_site_breast_o, r_site_axilla_o,
...
factor_vars$clinical_assessment_pet <- quos(which_breast_right_o, r_site_breast_o, r_site_axilla_o,
                                            r_site_supraclavicular_o, r_site_chest_wall_o,
                                            r_site_other_o, r_radiotherapy_aes,
                                            r_skin_erythema, r_pain, r_breast_oedema, r_breast_shrink,
                                            r_breast_pain,
                                            which_breast_left_o, l_site_breast_o, l_site_axilla_o,
                                            l_site_supraclaviculal_o, l_site_chest_wall_o,
                                            l_site_othel_o, l_radiotherapy_aes,
                                            l_skin_erythema, l_pain, l_breast_oedema, l_breast_shrink,
                                            l_breast_pain,
                                            metastatic, metatstatic_where_bone_o, metastatic_where_brain_o,
                                            metatstatc_where_cervical_node_o, metatstatc_where_liver_o,
                                            metastatic_where_lung_o, metastatic_where_other_o,
                                            plan_change_antioestrogen_o, plan_change_oth_o,
                                            plan_change_radio_o, plan_change_spcfy, plan_change_surgery_o)
