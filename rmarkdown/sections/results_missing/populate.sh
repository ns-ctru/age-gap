...
sed -e 's/template/radiotherapy/g'        patterns_template.Rmd \
    -e 's/TEMPLATE/individual_id, event_name, site, which_breast_right_radio, which_breast_left_radio, r_site_breast_radio, r_site_axilla, r_site_supraclavicular, r_site_chest_wall, r_site_other, r_breast_fractions, r_axilla_fractions, r_supra_fractions, r_chest_fractions, r_other_fractions, r_radiotherapy_aes, l_site_breast, l_site_axilla, l_site_supraclavicular, l_site_chest_wall, l_site_other, l_breast_fractions, l_axilla_fractions, l_supra_fractions, l_chest_fractions, l_other_fractions, l_radiotherapy_aes, r_skin_erythema, r_pain, r_breast_oedema, r_breast_shrink, r_breast_pain, l_skin_erythema, l_pain, l_breast_oedema, l_breast_shrink, l_breast_pain/g'      > patterns_radiotherapy.Rmd
## Trastuzumab
