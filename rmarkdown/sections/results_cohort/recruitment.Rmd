Recruitment is plotted and tabulated across all sites below, followed by summaries by site.  Note that the facetted plot showing screening and recruitment by site has a 'free' y-axis so that the plots are ledgible (if they were forced to all be the same sites that recruited very few participants would not be easy to read).
...
screening_recruitment$plotly_screened_recruited_site
screening_recruitment$table_screened_recruited_month %>%
    dplyr::filter(Site != 'All') %>%
