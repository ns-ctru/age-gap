...
plot_grid(cohort_plot_template1$outcome$boxplot    + facet_grid(.~chemotherapy),
          cohort_plot_template1$outcome$histogram  + facet_grid(.~chemotherapy),
          nrow  = 2,
          align = 'h')
...
#### TEMPLATE2
```{r results_cohort_summary_outcome_template2, echo = FALSE, warning = FALSE, message = FALSE, results = 'show', cache = FALSE, eval = TRUE}
plot_grid(cohort_plot_template2$outcome$boxplot    + facet_grid(.~chemotherapy),
          cohort_plot_template2$outcome$histogram  + facet_grid(.~chemotherapy),
          nrow  = 2,
          align = 'h')
...
plot_grid(cohort_plot_template3$outcome$boxplot    + facet_grid(.~chemotherapy),
          cohort_plot_template3$outcome$histogram  + facet_grid(.~chemotherapy),
          nrow  = 2,
          align = 'h')
